...
if(KRIMS_HAVE_GLIBC_STACKTRACE)
	...
	LIST(APPEND KRIMS_DEFINITIONS "KRIMS_HAVE_GLIBC_STACKTRACE")
endif()
...
if(KRIMS_HAVE_GLIBC_STACKTRACE)
	...
	if(KRIMS_HAVE_LIBSTDCXX_DEMANGLER)
		LIST(APPEND KRIMS_DEFINITIONS "KRIMS_HAVE_LIBSTDCXX_DEMANGLER")
	endif()
endif()
